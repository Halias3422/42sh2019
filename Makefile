...
#    Updated: 2019/05/20 15:09:39 by rlegendr    ###    #+. /#+    ###.fr      #
#                                                          /                   #
#                                                         /                    #
# **************************************************************************** #
...
SRC_NAME =	line_edit/calcul_line.c line_edit/check_input.c line_edit/escape_code.c line_edit/history.c \
			...
			line_edit/control_search_history.c line_edit/control_search_history_calcul_pos.c line_edit/search_in_history.c line_edit/env.c line_edit/input_is_remove_char.c line_edit/print_ans.c line_edit/debug.c\
			line_edit/copy.c line_edit/start_termcaps.c\
			line_edit/tab_key.c line_edit/tab_key_all_path.c line_edit/tab_key_sort.c line_edit/tab_key_current_dir.c line_edit/tab_key_tools_calcul_print.c line_edit/tab_key_tools_manip.c line_edit/tab_key_struct.c line_edit/tab_key_auto_complete.c\
