...
/*   Updated: 2019/05/29 10:28:36 by vde-sain    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
int							determ_flag_and_width_err(t_dataerr *data, char *format,
							int i);
char						*determ_data_err(char *format, t_dataerr *data, va_list va,
							int i);
char						determ_conv_err(t_dataerr *data, char conv, char *format,
							int i);
...
char						*backslash_strjoin_err(char *s1, char *s2, t_dataerr data);
...
int							add_color_to_output_err(t_dataerr *data, t_colorerr col,
							int i);
